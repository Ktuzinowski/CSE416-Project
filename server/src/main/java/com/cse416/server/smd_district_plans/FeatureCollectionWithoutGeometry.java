...
public class FeatureCollectionWithoutGeometry {
	@Id
	String id;
	String name;
	
	@Field("features")
	private List<FeatureWithoutGeometry> features;
	...
	public List<FeatureWithoutGeometry> getFeatures() {
		return features;
	}
	public void setFeatures(List<FeatureWithoutGeometry> features) {
