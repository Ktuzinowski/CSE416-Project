...
export const LeftDistrictPanelUT = ({ data, onSelectFeature, selectedRace, setSelectedRace, districtColors, onChangeBorderForHoverOverDistrict, onChangeLeftHoverOverDistrict }) => {
