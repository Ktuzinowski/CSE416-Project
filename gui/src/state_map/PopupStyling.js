...
export const getDistrictDataPopupContent = (feature) => {
    ...
    <div style="font-family: Arial, sans-serif; line-height: 1.5;">
        ...
        <p><strong>Population:</strong> ${feature.properties[CurrentDistrictPlansFeatureProperties.population]}</p>
...
export const getPrecinctDataPopupContent = (feature) => {
    ...
    <div style="font-family: Arial, sans-serif; line-height: 1.5;">
        <h3 style="margin: 0;">Precinct: ${
          feature.properties[PrecinctsFeatureProperties.precinct]}</h3>
        <p><strong>Population:</strong> ${feature.properties[PrecinctsFeatureProperties.population]}</p>
    <p><strong>Republican:</strong> ${(
