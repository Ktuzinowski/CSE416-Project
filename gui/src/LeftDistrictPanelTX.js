...
export const LeftDistrictPanelTX = ({ data, onSelectFeature, selectedRace, setSelectedRace, districtColors, onChangeBorderForHoverOverDistrict, onChangeLeftHoverOverDistrict }) => {
    ...
    return (
        ...
        <div className="container_left_data_panel" style={{
            ...
            >   
                ...
                <option value="WHT_NHSP21">White</option>
                <option value="BLK_NHSP21">Black</option>
                <option value="HSP_POP21">Hispanic</option>
                <option value="ASN_NHSP21">Asian</option>
                <option value="HPI_NHSP21">Pacific </option>
                <option value="AIA_NHSP21">Native </option>
                <option value="OTH_NHSP21">Other</option>
            </select>
